...
#include "../dcmimage/dicdefin.h" /* for export macros */
#include "../dcmimgle/diutils.h"  /* for EW_WindowType */
#include "../ofstd/ofstd.h"       /* for OFCondition */
#include "../dcmdata/dcxfer.h"    /* for E_TransferSyntax */
