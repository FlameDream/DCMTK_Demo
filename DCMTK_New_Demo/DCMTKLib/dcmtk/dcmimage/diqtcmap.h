...
#include "../dcmimage/diqttype.h"  /* for DcmQuantComponent */
#include "../dcmimgle/dcmimage.h"  /* gcc 3.4 needs this */
#include "../dcmimage/diqtstab.h"  /* gcc 3.4 needs this */
#include "../dcmimage/diqtpix.h"   /* gcc 3.4 needs this */
#include "../dcmimage/diqthash.h"  /* gcc 3.4 needs this */
#include "../dcmimage/diqtctab.h"  /* gcc 3.4 needs this */
