...
#include "../ofstd/oflist.h"     /* for class OFList */
#include "../ofstd/ofstring.h"   /* for class OFString */
#include "../ofstd/oftypes.h"    /* for OFBool */
#include "../ofstd/oftraits.h"   /* for OFenable_if, ... */
#include "../ofstd/ofcond.h"     /* for OFCondition */
#include "../ofstd/oflimits.h"   /* for OFnumeric_limits<T>::max() */
#include "../ofstd/oferror.h"
