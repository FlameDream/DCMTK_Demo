...
#ifndef DCMTK_LOG4CPLUS_LOGGERHEADER_
#define DCMTK_LOG4CPLUS_LOGGERHEADER_
...
#include "../oflog/spi/apndatch.h"
#include "../oflog/spi/logfact.h"

#include "../ofstd/ofvector.h"
...
namespace log4cplus
{
    ...
    /** \typedef OFVector<Logger> LoggerList
     * This is a list of {@link Logger Loggers}. */
    typedef OFVector<Logger> LoggerList;
...
#endif // DCMTK_LOG4CPLUS_LOGGERHEADER_
